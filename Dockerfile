...
RUN wget https://apache.mirrors.nublue.co.uk/tomcat/tomcat-8/v8.5.68/bin/apache-tomcat-8.5.68.tar.gz
RUN tar -zxvf apache-tomcat-8.5.68.tar.gz -C /opt/tomcat --strip-components=1
